...
pub struct RpcConfig {
    ...
    /// Enable the admin routes (e.g. persistent-peer add/remove).
    ///
    /// Disabled by default: these routes mutate node state and must not be
    /// reachable in the default configuration. Enable only on internal,
    /// trusted interfaces.
    pub admin: bool,
}
